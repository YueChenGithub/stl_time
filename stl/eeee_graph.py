...
def draw_and_save(Q, R, T, a1, a2, a3, a4, b1, b2, b3, b4, m, output_dir, r, robustness, save_data, t_left1, t_left2,
    ...
    axs[y_position].fill_between(np.arange(t_left1, t_right1 + 1), b1 / a1, b3 / a3, color='skyblue', alpha=0.5,
                                 label='Eventually')
    axs[y_position].fill_between(np.arange(t_left2, t_right2 + 1), b4 / a4, b2 / a2, color='skyblue', alpha=0.5)
    ...
    # plot xi
    rhos1 = cal_shifted_rho(a1, b1, t_left1, t_right1, y, 'F')
    rhos2 = cal_shifted_rho(a2, b2, t_left2, t_right2, y, 'F')
    rhos3 = cal_shifted_rho(a3, b3, t_left1, t_right1, y, 'F')
    rhos4 = cal_shifted_rho(a4, b4, t_left2, t_right2, y, 'F')
