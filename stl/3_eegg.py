...
def main(method, x0):
    ...
    if method not in ['mul', 'sum', 'xi']:
        ...
        r1s = finally_max(m, r1, 0, t_left1, t_right1) * weight_F
        r3 = predicate(m, y, a3, b3, robustness)
        r3s = finally_max(m, r3, 0, t_left1, t_right1)  * weight_F

        r2 = predicate(m, y, a2, b2, robustness)
        r2s = global_operator(m, r2, 0, t_left2, t_right2)
        r4 = predicate(m, y, a4, b4, robustness)
        r4s = global_operator(m, r4, 0, t_left2, t_right2)
        ...
        r1s_1 = finally_max(m, r1_1, 0, t_left1, t_right1)
        r1_2 = predicate(m, y, a1, b1, robustness='t_min')
        r1s_2 = finally_max(m, r1_2, 0, t_left1, t_right1)
        r3_1 = predicate(m, y, a3, b3, robustness='s')
        r3s_1 = finally_max(m, r3_1, 0, t_left1, t_right1)
        r3_2 = predicate(m, y, a3, b3, robustness='t_min')
        r3s_2 = finally_max(m, r3_2, 0, t_left1, t_right1)
        ...
        def get_rho(t0):
            r1_1 = predicate(m, y, a1, b1, robustness='s')
            r1s_1 = finally_max(m, r1_1, t0, t_left1, t_right1)
            r3_1 = predicate(m, y, a3, b3, robustness='s')
            r3s_1 = finally_max(m, r3_1, t0, t_left1, t_right1)
            r2_1 = predicate(m, y, a2, b2, robustness='s')
            r2s_1 = globally_min(m, r2_1, t0, t_left2, t_right2)
            r4_1 = predicate(m, y, a4, b4, robustness='s')
            r4s_1 = globally_min(m, r4_1, t0, t_left2, t_right2)
    ...
    save_data = True
    output_dir = f'./output/3_eegg_{x0[0]}/'
    operator = ['F', 'F', 'G', 'G']   # [r1, r3, r2, r4]
    draw_and_save(Q, R, T, a1, a2, a3, a4, b1, b2, b3, b4, m, output_dir, r, method, save_data, t_left1, t_left2,
