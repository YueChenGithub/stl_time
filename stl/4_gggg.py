...
def main(method, x0):
    ...
    if method not in ['mul', 'sum', 'xi']:
        ...
        r3s = global_operator(m, r3, 0, t_left1, t_right1)
    ...
    # m.setParam('DualReductions', 0)  # for c_sum2 with x0=30
    ...
    save_data = True
    output_dir = f'./output/4_gggg_{x0[0]}/'
    operator = ['G', 'G', 'G', 'G']   # [r1, r3, r2, r4]
