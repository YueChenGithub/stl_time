...
def main(method, x0):
    ...
    if method not in ['mul', 'sum', 'xi']:
        ...
        r1s = finally_max(m, r1, 0, t_left1, t_right1)
        r3 = predicate(m, y, a3, b3, robustness)
        r3s = finally_max(m, r3, 0, t_left1, t_right1)
        ...
        r4s_1 = finally_max(m, r4_1, 0, t_left2, t_right2)
        r4_2 = predicate(m, y, a4, b4, robustness='t_min')
        r4s_2 = finally_max(m, r4_2, 0, t_left2, t_right2)
    ...
    save_data = True
    output_dir = f'./output/5_eeee_{x0[0]}/'
    operator = ['F', 'F', 'F', 'F']   # [r1, r3, r2, r4]
