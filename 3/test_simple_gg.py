...
if __name__ == "__main__":
    ...
    axs[0].fill_between(np.arange(t_left, t_right + 1), b1 / a1, b2/a2, color='springgreen', alpha=0.5)
    axs[0].set_ylim(-2, 32)
    ...
    axs[3].fill_between(np.arange(t_left, t_right + 1), b1 / a1, b2/a2, color='springgreen', alpha=0.5)
    axs[3].set_ylim(-2, 32)
    ...
    p1_robustness_right, p1_rectangle_right = G_right(a1, b1, t_left, t_right, y)
    ...
    p1_robustness_left, p1_rectangle_left = G_left(a1, b1, t_left, t_right, y)
    ...
    p2_robustness_right, p2_rectangle_right = G_right(a2, b2, t_left, t_right, y)
    ...
    p2_robustness_left, p2_rectangle_left = G_left(a2, b2, t_left, t_right, y)
