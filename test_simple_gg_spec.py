...
if __name__ == "__main__":
    ...
    t_left1 = 15
    t_right1 = 25
    r1_s = predicate(m, y, a1, b1, robustness='s')
    r1s_s = globally_min(m, r1_s, 0, t_left1, t_right1)
    r1_t = predicate(m, y, a1, b1, robustness='t_min')
    r1s_t = globally_min(m, r1_t, 0, t_left1, t_right1)

    a2 = -1
    b2 = -20
    t_left2 = 15
    t_right2 = 25
    r2_s = predicate(m, y, a2, b2, robustness='s')
    r2s_s = globally_min(m, r2_s, 0, t_left2, t_right2)
    r2_t = predicate(m, y, a2, b2, robustness='t_min')
    r2s_t = globally_min(m, r2_t, 0, t_left2, t_right2)

    r1s = quant_and(m, [r1s_s, r2s_s])
    r2s = quant_and(m, [r1s_t, r1s_t])
