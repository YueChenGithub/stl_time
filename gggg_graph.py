...
def draw_and_save(Q, R, T, a1, a2, a3, a4, b1, b2, b3, b4, m, output_dir, r, robustness, save_data, t_left1, t_left2,
    ...
    fig, axs = plt.subplots(4, 1, figsize=(6, 13), gridspec_kw={'height_ratios': [6, 3, 2, 2]}, constrained_layout=True)
    # plot y
    y_position = 0
    axs[y_position].plot(t, y, '-')
    axs[y_position].set_title(f"Position")
    axs[y_position].fill_between(np.arange(t_left1, t_right1 + 1), b1 / a1, b3 / a3, color='springgreen', alpha=0.5,
                                 label='Globally')
    axs[y_position].fill_between(np.arange(t_left2, t_right2 + 1), b4 / a4, b2 / a2, color='springgreen', alpha=0.5)
    ...
    rhos2 = cal_shifted_rho(a2, b2, t_left2, t_right2, y, 'G')
    rhos3 = cal_shifted_rho(a3, b3, t_left1, t_right1, y, 'G')
    rhos4 = cal_shifted_rho(a4, b4, t_left2, t_right2, y, 'G')
