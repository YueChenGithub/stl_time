...
if __name__ == "__main__":
    ...
    rs = quant_finally(m, rho, 0, 10, 20)
    r = rs

    # rho, z = predicate(m, y, 1, 20, robustness='temporal')  # a*y - b > 0
    # rt = quant_finally(m, rho, 0, 10, 20)
    # r = rt

    # rho, z = predicate(m, y, 1, 20, robustness='combined')  # a*y - b > 0
    # rc = quant_finally(m, rho, 0, 10, 20)
    # r = rc
